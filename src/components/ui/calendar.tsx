...
import { enUS } from "date-fns/locale" // ✅ important for weekdays
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      locale={enUS} // ✅ FIXED: ensures weekdays show
      ...
      classNames={{
        ...
        head_row: "flex justify-between px-2", // ✅ spacing fix
        head_cell:
          "text-muted-foreground w-9 text-center rounded-md font-normal text-[0.8rem]", // ✅ added width
        row: "mt-2",
        cell:
