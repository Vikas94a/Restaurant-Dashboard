...
import { Restaurant } from "@/features/overview/components/RestaurantDialog"; // Importing the Restaurant type from another component
import { Input } from "@/components/ui/input"; // Custom Input component (probably from shadcn/ui or similar)
