...
import RestaurantType from "@/features/settings/components/RestaurantType"; // Subcomponent for selecting restaurant type
import RestaurantTiming from "@/features/settings/components/RestaurantTiming"; // Subcomponent for setting opening hours
