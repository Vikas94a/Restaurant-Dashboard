              ...
              <div className="md:col-span-2">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-blue-800">
                    Reservation availability is automatically determined by your restaurant's operating hours 
                    set in the Restaurant Settings. No need to configure separate hours here.
                  </p>
                </div>
              </div>
